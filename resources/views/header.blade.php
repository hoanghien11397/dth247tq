      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="index.html" class="text-black h2 mb-0"><img src="{{ asset('images/logo1.jpg')}}" style="width: 100%; height: 100%" alt=""></a></h1>
          </div>
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li><a href="#team-section" class="nav-link">Tin tức</a></li>
                <li><a href="#services-section" class="nav-link">Dịch vụ</a></li>
                <li><a href="#testimonials-section" class="nav-link">Trải nghiệm</a></li>
