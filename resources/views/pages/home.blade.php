        ...
        <div class="row">
            ...
            <form action="#" class="p-5 bg-white">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <textarea name="message" id="message" cols="30" rows="7" class="form-control" placeholder="Nhập nội dung tại đây..."></textarea>
                </div>
              </div>
          ...
          <div class="col-md-5">
            ...
            <div class="p-4 mb-3 bg-white">
              ...
              <p class="mb-4">Tòa CT2, khu đô thị Thái Hà Constrexim, 43 Phạm Văn Đồng, Hà Nội</p>
